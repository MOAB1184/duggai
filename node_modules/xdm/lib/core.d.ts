...
export type RecmaDocumentOptions =
  import('xdm/lib/plugin/recma-document.js').RecmaDocumentOptions
export type RecmaStringifyOptions =
  import('xdm/lib/plugin/recma-stringify.js').RecmaStringifyOptions
export type RecmaJsxRewriteOptions =
  import('xdm/lib/plugin/recma-jsx-rewrite.js').RecmaJsxRewriteOptions
